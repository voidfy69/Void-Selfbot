...
activity = discord.Activity(type=discord.ActivityType.streaming, name="Jay Shree Ram 🚩")
...
async def selfbot(ctx):
    version = "V1"  # Update with your actual version
    language = "Python"
    ...
    message = f"{author} **__PAPA S3LFB0T__**\n\n" \
              ...
              f"**• Link: https://discord.gg/5U6yTjV2UC**\n"
