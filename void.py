...
response = self.session.get("https://github.com/notAizer/Thallium-Nuker/releases/latest")
                ...
                if VERSION != check_version:
                    print("{}({}LUCIFER X RAVAN{}) You're using an outdated version!".format("\x1b[0m", "\x1b[38;5;122m", "\x1b[0m"))
                    webbrowser.open(f"https://github.com/notAizer/Thallium-Nuker/releases/tag/{check_version}")
                else:
                    print("{}({}LUCIFER X RAVAN{}) You're using the current version!".format("\x1b[0m", "\x1b[38;5;122m", "\x1b[0m"))
            except:
                print("{}({}LUCIFER X RAVAN{}) Couldn't reach the releases!".format("\x1b[0m", "\x1b[38;5;122m", "\x1b[0m"))
